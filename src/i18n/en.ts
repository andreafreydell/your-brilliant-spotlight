const en: Record<string, string> = {
  ...
  "home.about.bio2": "She works with organizations that care about quality, brand consistency, and execution — and helps them build the systems to move faster by building reliable AI systems with human-centric design that empower employees to let their talents shine.",
  ...
  // Courses page
  "courses.label": "System Library",
  "courses.title": "Copy the workflow you need.",
  "courses.subtitle": "Start with the foundations — they're free. Then grab the advanced systems for content, image, brand, and web production.",
  "courses.limitedTime.label": "Free Access",
  "courses.limitedTime.title": "Currently free — start here",
  "courses.limitedTime.seeCoursePath": "See the full system path",
  "courses.browse.label": "All Systems",
  "courses.browse.suffix": "workflows across foundations and advanced systems",
  "courses.filter.all": "All",
  "courses.filter.foundations": "Foundations",
  "courses.filter.advanced": "Advanced Systems",
  "courses.recommendation.label": "Not sure where to start?",
  "courses.recommendation.title": "Book a free call and I'll tell you exactly what to build first.",
  "courses.recommendation.subtitle": "If you already know the bottleneck, grab the system that solves it. If not, 15 minutes on a call will save you hours of guessing.",
  ...
  "services.courseLibrary.desc": "Self-serve workflow blueprints you can copy and implement on your own.",
  "services.courseLibrary.item1": "Standalone systems",
  "services.courseLibrary.item2": "Bundles",
  "services.courseLibrary.item3": "Clear implementation paths",
  "services.membership.title": "Mentorship",
  "services.membership.desc": "Full library access plus future systems, monthly drops, and ongoing support.",
  "services.membership.item1": "Every system included",
  "services.membership.item2": "Future workflow releases",
  "services.membership.item3": "Community access",
  "services.customBuilds.title": "Custom Builds",
  "services.customBuilds.desc": "For businesses that need a system built specifically for their stack and workflow.",
  ...
  // CourseDetail page
  "courseDetail.backToLibrary": "Back to system library",
  "courseDetail.foundations": "Foundations",
  "courseDetail.advancedWorkflow": "Advanced System",
  "courseDetail.getFreeAccess": "Get Free Access",
  "courseDetail.requestAccess": "Request Access",
  "courseDetail.viewCourseContent": "View System Content",
  ...
  "courseDetail.courseContent": "System Content",
  ...
  "courseLesson.backToCourse": "Back to System",
  "courseLesson.lessonOverview": "Lesson Overview",
  "courseLesson.linkedCourse": "Linked system",
  ...
  "courseCard.advancedWorkflow": "Advanced System",
  "courseCard.limitedTime": "Free",
  "courseCard.explore": "Explore system",

  // OfferCard
  "offerCard.viewFree": "Start Free",
