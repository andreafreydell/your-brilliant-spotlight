const en: Record<string, string> = {
  ...
  "home.about.bio2": "She helps organizations that care about quality and consistency build the operational systems to move faster — combining AI, brand thinking, and practical design so teams can focus on the work that actually matters.",
