const es: Record<string, string> = {
  ...
  // Courses page
  "courses.label": "Biblioteca de Sistemas",
  "courses.title": "Copia el flujo que necesitas.",
  "courses.subtitle": "Empieza con las bases — son gratis. Luego toma los sistemas avanzados de contenido, imagen, marca y producción web.",
  "courses.limitedTime.label": "Acceso Gratuito",
  "courses.limitedTime.title": "Actualmente gratis — empieza aquí",
  "courses.limitedTime.seeCoursePath": "Ver la ruta completa",
  "courses.browse.label": "Todos los Sistemas",
  "courses.browse.suffix": "flujos en bases y sistemas avanzados",
  ...
  "services.courseLibrary.desc": "Plantillas de flujos de trabajo self-serve que puedes copiar e implementar por tu cuenta.",
  "services.courseLibrary.item1": "Sistemas individuales",
  "services.courseLibrary.item2": "Paquetes",
  "services.courseLibrary.item3": "Rutas de implementación claras",
  "services.membership.title": "Mentoría",
  "services.membership.desc": "Acceso completo a la biblioteca más sistemas futuros, lanzamientos mensuales y soporte continuo.",
  "services.membership.item1": "Todos los sistemas incluidos",
  "services.membership.item2": "Futuros lanzamientos",
  "services.membership.item3": "Acceso a comunidad",
  "services.customBuilds.title": "Builds Personalizados",
  "services.customBuilds.desc": "Para negocios que necesitan un sistema construido específicamente para su stack y flujo.",
  ...
  "contact.interest.custom": "Build personalizado",
  ...
  // CourseDetail page
  "courseDetail.backToLibrary": "Volver a la biblioteca de sistemas",
  "courseDetail.foundations": "Bases",
  "courseDetail.advancedWorkflow": "Sistema Avanzado",
  "courseDetail.getFreeAccess": "Obtener Acceso Gratuito",
  "courseDetail.requestAccess": "Solicitar Acceso",
  "courseDetail.viewCourseContent": "Ver Contenido del Sistema",
  ...
  "courseDetail.courseContent": "Contenido del Sistema",
  ...
  "courseLesson.backToCourse": "Volver al Sistema",
  "courseLesson.lessonOverview": "Resumen de la Lección",
  "courseLesson.linkedCourse": "Sistema vinculado",
  ...
  "courseCard.advancedWorkflow": "Sistema Avanzado",
  "courseCard.limitedTime": "Gratis",
  "courseCard.explore": "Explorar sistema",

  // OfferCard
  "offerCard.viewFree": "Empezar Gratis",
